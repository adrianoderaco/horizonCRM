...
export const agentAPI = {
    ...
    async releaseMyTickets(agentId) {
        if (!agentId) throw new Error("ID do agente é obrigatório para liberar tickets.");
        
        // PROTEÇÃO: O .eq garante que apenas os tickets atrelados ao ID Deste agente específico voltem pra fila.
    ...
    // ==========================================
    // 4. CONFIGURAÇÕES DO SISTEMA (SLA E MACROS)
    // ==========================================
    ...
    // ==========================================
    // 6. GESTÃO DE EQUIPE, STATUS E PONTO
    // ==========================================
